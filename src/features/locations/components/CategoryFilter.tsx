  ...
  return (
    ...
    >
      <TouchableOpacity
        ...
        activeOpacity={0.7}
      >
        <Text className={`font-semibold ${!selectedCategory ? 'text-white' : 'text-gray-600'}`}>All</Text>
      </TouchableOpacity>
      ...
      {CATEGORIES.map((category) => {
        ...
        return (
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Text className={`font-semibold ${isSelected ? 'text-white' : 'text-gray-600'}`}>{category}</Text>
          </TouchableOpacity>
        );
      })}
    </ScrollView>
